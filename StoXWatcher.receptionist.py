...
# TODO: Command line to add authorized user and remove authorized user
...
def main() -> None:
    ...
    restrict_handler = MessageHandler(~chatid_filter, restrict)
...
if __name__ == "__main__":
    ...
    # Initialize the chat ID filter object
